...
//            // We've bound to LocalService, cast the IBinder and get LocalService instance
    ...
    public void showDialog(){
        ...
        MaterialCardView textYes = (MaterialCardView) dialog.findViewById(R.id.materialYes);
        MaterialCardView textNo = (MaterialCardView) dialog.findViewById(R.id.materialNo);
