...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private String createNotificationChannel(String channelId) {
        if (lastChannel == null || lastChannel.isEmpty()) {
            NotificationChannel chan = new NotificationChannel(channelId,
                    getString(R.string.channel_name_background), NotificationManager.IMPORTANCE_DEFAULT); // Set importance to DEFAULT
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel,
        ...
        if (channel.equals(NOTIFICATION_CHANNEL_BG_ID))
            priority = Notification.PRIORITY_MIN; // Use Notification.PRIORITY_MIN instead of PRIORITY_MIN
        else if (channel.equals(NOTIFICATION_CHANNEL_USERREQ_ID))
            priority = Notification.PRIORITY_MAX; // Use Notification.PRIORITY_MAX instead of PRIORITY_MAX
        else
            priority = Notification.PRIORITY_DEFAULT; // Use Notification.PRIORITY_DEFAULT instead of PRIORITY_DEFAULT
        ...
        if (status == LEVEL_WAITING_FOR_USER_INPUT) {
            PendingIntent pIntent = PendingIntent.getActivity(this,
                    0, intent, PendingIntent.FLAG_UPDATE_CURRENT); // Use FLAG_UPDATE_CURRENT for PendingIntent
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            nBuilder.setPriority(priority); // Set notification priority directly
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel,
        ...
        Intent intent1 = null;
       *//* try {
            intent = new Intent(this,Class.forName("com.example.kotlintest.vpn.VpnConnectivity"));
...
*/
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
        Intent disconnectVPN = null;
        try {
            disconnectVPN = new Intent(this,Class.forName("com.example.kotlintest.vpn.VpnConnectivity"));
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
//        Intent disconnectVPN = new Intent(this, /*DisconnectVPNActivity.class*/);
    ...
    PendingIntent getGraphPendingIntent() {
      ...
      /*  intent.setComponent(new ComponentName(this, getPackageName() + "com.example.kotlintest.vpn.MainActivity"));
    ...
    private void startOpenVPN() throws Exception {
        try {
